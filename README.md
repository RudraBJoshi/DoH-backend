...
This project is **no longer actively maintained** by the original team (MalwareMadness) and will be handed off to the next team. If you want to build on it, use it as a template rather than forking:
